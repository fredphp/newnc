...
if(data.sf1=='0'  && data.youjifei>'0'){//施肥     1
   $('.easte li').eq(0).find('.shifeiBtn').css('z-index', '999');
$('.easte li').eq(0).find('.shifeiBtn').css('opacity', '1')}
   }else{
	 //除虫 ，浇水， 除草  1
	if(data.ch1==1){$(".easte li").eq(0).removeClass();$(".easte li").eq(0).addClass("xinxi_chanchu_chuchong");$('.easte li').eq(0).find('.chongzi').css('display', 'block');}
    if(data.gh1==1){$(".easte li").eq(0).removeClass();$(".easte li").eq(0).addClass("xinxi_chanchu_jiaoshui");$('.easte li').eq(0).find('.water').css('display', 'block');}	
	if(data.zc1==1){$(".easte li").eq(0).removeClass();$(".easte li").eq(0).addClass("xinxi_chanchu_chucao");$('.easte li').eq(0).find('.zachao').css('display', 'block');}		
	if(data.ch1==0 && data.gh1==0 && data.zc1==0){$(".easte li").eq(0).addClass("xinxi_chanchu");}	
...
if(data.sf2=='0'  && data.youjifei>'0'){//施肥   2
  $('.easte li').eq(1).find('.shifeiBtn').css('z-index', '999');
$('.easte li').eq(1).find('.shifeiBtn').css('opacity', '1')} 
  }else{
  //除虫 ，浇水， 除草  2
		if(data.ch1==1){$(".easte li").eq(1).removeClass();$(".easte li").eq(1).addClass("xinxi_chanchu_chuchong");$('.easte li').eq(1).find('.chongzi').css('display', 'block');}
    if(data.gh1==1){$(".easte li").eq(1).removeClass();$(".easte li").eq(1).addClass("xinxi_chanchu_jiaoshui");$('.easte li').eq(1).find('.water').css('display', 'block');}	
	if(data.zc1==1){$(".easte li").eq(1).removeClass();$(".easte li").eq(1).addClass("xinxi_chanchu_chucao");$('.easte li').eq(1).find('.zachao').css('display', 'block');}		
	if(data.ch1==0 && data.gh1==0 && data.zc1==0){$(".easte li").eq(1).addClass("xinxi_chanchu");}	
...
if(data.sf3=='0'  && data.youjifei>'0'){//施肥    3
  $('.easte li').eq(2).find('.shifeiBtn').css('z-index', '999');
$('.easte li').eq(2).find('.shifeiBtn').css('opacity', '1')} 
  }else{
	//除虫 ，浇水， 除草  3
		if(data.ch1==1){$(".easte li").eq(2).removeClass();$(".easte li").eq(2).addClass("xinxi_chanchu_chuchong");$('.easte li').eq(2).find('.chongzi').css('display', 'block');}
    if(data.gh1==1){$(".easte li").eq(2).removeClass();$(".easte li").eq(2).addClass("xinxi_chanchu_jiaoshui");$('.easte li').eq(2).find('.water').css('display', 'block');}	
	if(data.zc1==1){$(".easte li").eq(2).removeClass();$(".easte li").eq(2).addClass("xinxi_chanchu_chucao");$('.easte li').eq(2).find('.zachao').css('display', 'block');}		
	if(data.ch1==0 && data.gh1==0 && data.zc1==0){$(".easte li").eq(2).addClass("xinxi_chanchu");}	
...
if(data.sf4=='0'  && data.youjifei>'0'){//施肥    4
  $('.easte li').eq(3).find('.shifeiBtn').css('z-index', '999');
$('.easte li').eq(3).find('.shifeiBtn').css('opacity', '1')} 
  }else{
	//除虫 ，浇水， 除草  4
		if(data.ch1==1){$(".easte li").eq(3).removeClass();$(".easte li").eq(3).addClass("xinxi_chanchu_chuchong");$('.easte li').eq(3).find('.chongzi').css('display', 'block');}
    if(data.gh1==1){$(".easte li").eq(3).removeClass();$(".easte li").eq(3).addClass("xinxi_chanchu_jiaoshui");$('.easte li').eq(3).find('.water').css('display', 'block');}	
	if(data.zc1==1){$(".easte li").eq(3).removeClass();$(".easte li").eq(3).addClass("xinxi_chanchu_chucao");$('.easte li').eq(3).find('.zachao').css('display', 'block');}		
	if(data.ch1==0 && data.gh1==0 && data.zc1==0){$(".easte li").eq(3).addClass("xinxi_chanchu");}	
...
if(data.sf5=='0'  && data.youjifei>'0'){//施肥    5
  $('.easte li').eq(4).find('.shifeiBtn').css('z-index', '999');
$('.easte li').eq(4).find('.shifeiBtn').css('opacity', '1')} 
  }else{
	//除虫 ，浇水， 除草  5
		if(data.ch1==1){$(".easte li").eq(4).removeClass();$(".easte li").eq(4).addClass("xinxi_chanchu_chuchong");$('.easte li').eq(4).find('.chongzi').css('display', 'block');}
    if(data.gh1==1){$(".easte li").eq(4).removeClass();$(".easte li").eq(4).addClass("xinxi_chanchu_jiaoshui");$('.easte li').eq(4).find('.water').css('display', 'block');}	
	if(data.zc1==1){$(".easte li").eq(4).removeClass();$(".easte li").eq(4).addClass("xinxi_chanchu_chucao");$('.easte li').eq(4).find('.zachao').css('display', 'block');}		
	if(data.ch1==0 && data.gh1==0 && data.zc1==0){$(".easte li").eq(4).addClass("xinxi_chanchu");}	
...
if(data.sf6=='0'  && data.youjifei>'0'){//施肥    6
  $('.easte li').eq(5).find('.shifeiBtn').css('z-index', '999');
$('.easte li').eq(5).find('.shifeiBtn').css('opacity', '1')} 
  }else{
	//除虫 ，浇水， 除草  6
		if(data.ch1==1){$(".easte li").eq(5).removeClass();$(".easte li").eq(5).addClass("xinxi_chanchu_chuchong");$('.easte li').eq(5).find('.chongzi').css('display', 'block');}
    if(data.gh1==1){$(".easte li").eq(5).removeClass();$(".easte li").eq(5).addClass("xinxi_chanchu_jiaoshui");$('.easte li').eq(5).find('.water').css('display', 'block');}	
	if(data.zc1==1){$(".easte li").eq(5).removeClass();$(".easte li").eq(5).addClass("xinxi_chanchu_chucao");$('.easte li').eq(5).find('.zachao').css('display', 'block');}		
	if(data.ch1==0 && data.gh1==0 && data.zc1==0){$(".easte li").eq(5).addClass("xinxi_chanchu");}	
...
if(data.sf7=='0'  && data.youjifei>'0'){//施肥    7
  $('.easte li').eq(6).find('.shifeiBtn').css('z-index', '999');
$('.easte li').eq(6).find('.shifeiBtn').css('opacity', '1')} 
  }else{
	//除虫 ，浇水， 除草  7
		if(data.ch1==1){$(".easte li").eq(6).removeClass();$(".easte li").eq(6).addClass("xinxi_chanchu_chuchong");$('.easte li').eq(6).find('.chongzi').css('display', 'block');}
    if(data.gh1==1){$(".easte li").eq(6).removeClass();$(".easte li").eq(6).addClass("xinxi_chanchu_jiaoshui");$('.easte li').eq(6).find('.water').css('display', 'block');}	
	if(data.zc1==1){$(".easte li").eq(6).removeClass();$(".easte li").eq(6).addClass("xinxi_chanchu_chucao");$('.easte li').eq(6).find('.zachao').css('display', 'block');}		
	if(data.ch1==0 && data.gh1==0 && data.zc1==0){$(".easte li").eq(6).addClass("xinxi_chanchu");}	
...
if(data.sf8=='0'  && data.youjifei>'0'){//施肥    8
  $('.easte li').eq(7).find('.shifeiBtn').css('z-index', '999');
$('.easte li').eq(7).find('.shifeiBtn').css('opacity', '1')} 
  }else{
	//除虫 ，浇水， 除草  8
		if(data.ch1==1){$(".easte li").eq(7).removeClass();$(".easte li").eq(7).addClass("xinxi_chanchu_chuchong");$('.easte li').eq(7).find('.chongzi').css('display', 'block');}
    if(data.gh1==1){$(".easte li").eq(7).removeClass();$(".easte li").eq(7).addClass("xinxi_chanchu_jiaoshui");$('.easte li').eq(7).find('.water').css('display', 'block');}	
	if(data.zc1==1){$(".easte li").eq(7).removeClass();$(".easte li").eq(7).addClass("xinxi_chanchu_chucao");$('.easte li').eq(7).find('.zachao').css('display', 'block');}		
	if(data.ch1==0 && data.gh1==0 && data.zc1==0){$(".easte li").eq(7).addClass("xinxi_chanchu");}	
...
if(data.sf9=='0'  && data.youjifei>'0'){//施肥   9
  $('.easte li').eq(8).find('.shifeiBtn').css('z-index', '999');
$('.easte li').eq(8).find('.shifeiBtn').css('opacity', '1')} 
  }else{
	//除虫 ，浇水， 除草  9
		if(data.ch1==1){$(".easte li").eq(8).removeClass();$(".easte li").eq(8).addClass("xinxi_chanchu_chuchong");$('.easte li').eq(8).find('.chongzi').css('display', 'block');}
    if(data.gh1==1){$(".easte li").eq(8).removeClass();$(".easte li").eq(8).addClass("xinxi_chanchu_jiaoshui");$('.easte li').eq(8).find('.water').css('display', 'block');}	
	if(data.zc1==1){$(".easte li").eq(8).removeClass();$(".easte li").eq(8).addClass("xinxi_chanchu_chucao");$('.easte li').eq(8).find('.zachao').css('display', 'block');}		
	if(data.ch1==0 && data.gh1==0 && data.zc1==0){$(".easte li").eq(8).addClass("xinxi_chanchu");}	
...
if(data.sf10=='0'  && data.youjifei>'0'){//施肥   10
  $('.easte li').eq(9).find('.shifeiBtn').css('z-index', '999');
$('.easte li').eq(9).find('.shifeiBtn').css('opacity', '1')} 
  }else{
	//除虫 ，浇水， 除草  10
		if(data.ch1==1){$(".easte li").eq(9).removeClass();$(".easte li").eq(9).addClass("xinxi_chanchu_chuchong");$('.easte li').eq(9).find('.chongzi').css('display', 'block');}
    if(data.gh1==1){$(".easte li").eq(9).removeClass();$(".easte li").eq(9).addClass("xinxi_chanchu_jiaoshui");$('.easte li').eq(9).find('.water').css('display', 'block');}	
	if(data.zc1==1){$(".easte li").eq(9).removeClass();$(".easte li").eq(9).addClass("xinxi_chanchu_chucao");$('.easte li').eq(9).find('.zachao').css('display', 'block');}		
	if(data.ch1==0 && data.gh1==0 && data.zc1==0){$(".easte li").eq(9).addClass("xinxi_chanchu");}	
...
if(data.sf11=='0'  && data.youjifei>'0'){//施肥   11
  $('.easte li').eq(10).find('.shifeiBtn').css('z-index', '999');
$('.easte li').eq(10).find('.shifeiBtn').css('opacity', '1')} 
  }else{
	//除虫 ，浇水， 除草  11
		if(data.ch1==1){$(".easte li").eq(10).removeClass();$(".easte li").eq(10).addClass("xinxi_chanchu_chuchong");$('.easte li').eq(10).find('.chongzi').css('display', 'block');}
    if(data.gh1==1){$(".easte li").eq(10).removeClass();$(".easte li").eq(10).addClass("xinxi_chanchu_jiaoshui");$('.easte li').eq(10).find('.water').css('display', 'block');}	
	if(data.zc1==1){$(".easte li").eq(10).removeClass();$(".easte li").eq(10).addClass("xinxi_chanchu_chucao");$('.easte li').eq(10).find('.zachao').css('display', 'block');}		
	if(data.ch1==0 && data.gh1==0 && data.zc1==0){$(".easte li").eq(10).addClass("xinxi_chanchu");}	
...
if(data.sf12=='0' && data.youjifei>'0'){//施肥   12
  $('.easte li').eq(11).find('.shifeiBtn').css('z-index', '999');
$('.easte li').eq(11).find('.shifeiBtn').css('opacity', '1')} 
  }else{
	//除虫 ，浇水， 除草  12
		if(data.ch1==1){$(".easte li").eq(11).removeClass();$(".easte li").eq(11).addClass("xinxi_chanchu_chuchong");$('.easte li').eq(11).find('.chongzi').css('display', 'block');}
    if(data.gh1==1){$(".easte li").eq(11).removeClass();$(".easte li").eq(11).addClass("xinxi_chanchu_jiaoshui");$('.easte li').eq(11).find('.water').css('display', 'block');}	
	if(data.zc1==1){$(".easte li").eq(11).removeClass();$(".easte li").eq(11).addClass("xinxi_chanchu_chucao");$('.easte li').eq(11).find('.zachao').css('display', 'block');}		
	if(data.ch1==0 && data.gh1==0 && data.zc1==0){$(".easte li").eq(11).addClass("xinxi_chanchu");}	
...
$('.lanbaoshi').html(data.lanbaoshi);
$('.huangbaoshi').html(data.huangbaoshi);
$('#cw_name').html(data.cw_name);//宠物信息
$('#cw_pingfen').html(data.cw_pingfen);//宠物信息
$('#cw_luck').html(data.cw_luck);//宠物信息
$('#cw_speed').html(data.cw_speed);//宠物信息
$('#cw_attak').html(data.cw_attak);//宠物信息
$('#cw_defense').html(data.cw_defense);//宠物信息
$('#cw_tili_t').html(data.cw_tili_t);//宠物信息
$('#cw_jinyan_t').html(data.cw_jinyan_t);//宠物信息
$('#cw_lvl').html(data.cw_lvl);//宠物信息
$('#cw_hp').html(data.cw_hp);//宠物信息
                    $('#memberGoldTop').html(data.gold);
                    $('#memberDiamondTop').html(data.zs);
					$('#lvl').html(data.lvl);
			//自动收获进度条
		$('#pandaJindu1').find('div').css('width', +data.cw_jinyan_t+ '%')
		$('#pandaJindu2').find('div').css('width', +data.cw_tili_t+ '%')
		$('#lsj_rose').html(data.pet_rose_heart)//玫瑰之心
			
	$('.BigHouse').css('background', 'url(' + PUBLIC + '/house_list/'+ data.f_img + '.png)').css('background-size', 'cover');
					//$('.BigHouse').css('background', 'url(' + PUBLIC + '/house_list/' + data.f_img + ').css('background-size', 'cover'')
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (datas.pet_auto_harvest == 1) {
                            //定时1小时
                            var time =  datas.pet_experience;
                            var time0 = datas.pet_netx_exp;
                            setInterval(function () {
                                time--;
                                $('.progressBar1').find('div').css('width', time / time0 * 100 + '%')
                            }, 1000);
                        }
            ...
            if (petId != '') {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        datas = eval(data)
                        if (datas.pet_auto_seed == 1) {
                            //定时1小时
                            var time = 3600 * datas.jindutime2;
                            var time0 = 3600 * datas.config_auto_seed_time;
                            setInterval(function () {
                                time--;
                                $('.progressBar2').find('div').css('width', +cha2 * 100 + '%')
                            }, 1000);
                        }
                    ...
                    if (this.index == 0) {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                datas = eval(data)
                $('.easte li').eq(0).find('.shifeiBtn').css('opacity', '0')
				$('.easte li').eq(1).find('.shifeiBtn').css('opacity', '0')
				$('.easte li').eq(2).find('.shifeiBtn').css('opacity', '0')
				$('.easte li').eq(3).find('.shifeiBtn').css('opacity', '0')
				$('.easte li').eq(4).find('.shifeiBtn').css('opacity', '0')
				$('.easte li').eq(5).find('.shifeiBtn').css('opacity', '0')
				$('.easte li').eq(6).find('.shifeiBtn').css('opacity', '0')
				$('.easte li').eq(7).find('.shifeiBtn').css('opacity', '0')
				$('.easte li').eq(8).find('.shifeiBtn').css('opacity', '0')
				$('.easte li').eq(9).find('.shifeiBtn').css('opacity', '0')
				$('.easte li').eq(10).find('.shifeiBtn').css('opacity', '0')
				$('.easte li').eq(11).find('.shifeiBtn').css('opacity', '0')
				
				$(".easte li").eq(0).removeClass();$(".easte li").eq(0).addClass("qingli");
				$(".easte li").eq(1).removeClass();$(".easte li").eq(1).addClass("qingli");
				$(".easte li").eq(2).removeClass();$(".easte li").eq(2).addClass("qingli");
				$(".easte li").eq(3).removeClass();$(".easte li").eq(3).addClass("qingli");
				$(".easte li").eq(4).removeClass();$(".easte li").eq(4).addClass("qingli");
				$(".easte li").eq(5).removeClass();$(".easte li").eq(5).addClass("qingli");
				$(".easte li").eq(6).removeClass();$(".easte li").eq(6).addClass("qingli");
				$(".easte li").eq(7).removeClass();$(".easte li").eq(7).addClass("qingli");
				$(".easte li").eq(8).removeClass();$(".easte li").eq(8).addClass("qingli");
				$(".easte li").eq(9).removeClass();$(".easte li").eq(9).addClass("qingli");
				$(".easte li").eq(10).removeClass();$(".easte li").eq(10).addClass("qingli");
				$(".easte li").eq(11).removeClass();$(".easte li").eq(11).addClass("qingli");
						
                                $(".duihuan_chenggong").css("display", "block").removeClass("bounceOut").addClass("bounceIn");
                                $(".duihuan_chenggong").html(datas.msg)
							if(datas.id==1){$('.progressBar1').find('div').css('width', 100 + '%')}	
                            if(datas.id==2){$('.progressBar2').find('div').css('width', 100 + '%')}
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $(".duihuan_chenggong").html(datas.msg);
                            ...
                            //定时1小时
                            var jy =  datas.jy;
                            var next_jy = datas.next_jy;
							var tili =  datas.tili;
                            var next_tili = 100; 
                            $('.pandaJindu1').find('div').css('width', jy / next_jy * 100 + '%')
                          $('.pandaJindu2').find('div').css('width', tili / 100 * 100 + '%')
                        ...
                        success: function (data) {
                            ...
                            if (datas.code == '1') {
                                ...
                                if (getLevel == 'none') {
                                    $.ajax({
                                        type: "post",
                                        url: APP + "?m=user&a=getNowHouseImg",
                                        dataType: "json",
                                        success: function (imgData) {
                                            imgDatas = eval(imgData)

                                            $('.BigHouse').css('background', 'url(' + PUBLIC + '/Public/' + imgDatas.img + ')')
...
//游戏
    ...
    game.prototype = {
        ...
        bozhongYes_btn: function () {
            var that = this;
            if (!that.bozhongYes) {
                console.warn("bozhongYes element not found");
                return;
            }
        ...
        chanchuYes_btn: function () {
            ...
            var that = this;
            if (!that.chanchuYes) {
                console.warn("chanchuYes element not found");
                return;
            }
        ...
        shougeYes_btn: function () {
            ...
            var that = this;
            if (!that.shougeYes) {
                console.warn("shougeYes element not found");
                return;
            }
...
$(".easte li").eq(landNum2).addClass("qingli");
        ...
        shifeiYes_btn: function () {
            var that = this;
            if (!that.shifeiYes) {
                console.warn("shifeiYes element not found");
                return;
            }
            that.shifeiYes.addEventListener("touchstart", function (e) {
                e.preventDefault();
                that.shifeiYes.classList.add("rubberBand");
                setTimeout(function () {
                    $(".shifeiYes").removeClass("rubberBand")
                }, 100)
                that.btn_animate.yinxiao_btn();
            }, false);
            that.shifeiYes.addEventListener("touchend", function (e) {
                e.preventDefault();
                $(".shifeiAlert").css("display", "none");
                $(".shade").css("display", "none");
                $("#mengban").hide();
            }, false);
        },		
        ...
        sicoZhezhao_btn: function () {
            var that = this;
            if (!that.sicoZhezhao) {
                console.warn("sicoZhezhao element not found");
                return;
            }
    ...
    // Check if we're on the game page (not login page) before initializing
    if ($('.easte').length > 0) {
        var playGame = new game();
        playGame.play();
    } else {
        // Hide loading screen if we're on login page
        $('#load').hide();
    }
...
// Fallback: Hide loading screen after 5 seconds in case of initialization issues
setTimeout(function() {
    $('#load').hide();
}, 5000);
